...
def test_company_lottery_end_to_end_from_sale_to_next_round(app_context, headers):
    ...
    # 同一个开奖周期不能重复发
    assert "已经发过了" in send("e2e-welfare2", "e2e-1", "/发放福利", draw_tick)
