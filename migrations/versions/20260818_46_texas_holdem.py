...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("minimum_players_snapshot", sa.Integer(), nullable=False),
        sa.Column("maximum_players_snapshot", sa.Integer(), nullable=False),
        sa.Column("daily_start_limit_snapshot", sa.Integer(), nullable=False),
        sa.Column("action_timeout_seconds_snapshot", sa.Integer(), nullable=False),
        sa.Column("small_blind_percent_snapshot", sa.Integer(), nullable=False),
        sa.Column("big_blind_percent_snapshot", sa.Integer(), nullable=False),
